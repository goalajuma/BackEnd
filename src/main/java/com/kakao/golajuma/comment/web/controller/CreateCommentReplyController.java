...
public class CreateCommentReplyController {
    ...
    @PostMapping
    public ApiResponse<ApiResponseBody.SuccessBody<CreateCommentReplyResponse>> createCommentReply(@PathVariable Long commentId,
                                                                                  @Valid @RequestBody CreateCommentReplyRequest requestDto,
                                                                                  @Login Long userId) {
        CreateCommentReplyResponse response = createCommentService.execute(requestDto, commentId, userId);
